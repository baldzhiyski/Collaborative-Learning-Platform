    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity, OAuthSuccessHandler oAuthSuccessHandler) throws Exception {
        httpSecurity
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/", "/users/login","/universities/add-uni", "/users/register", "/users/login-error","/access-denied","/about-us","/users/activate/{activation_code}","/users/last-register-step").permitAll()
